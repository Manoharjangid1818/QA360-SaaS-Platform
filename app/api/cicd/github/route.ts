// GET /api/cicd/github — GitHub-specific pipelines + stats
...
export async function GET() {
  ensureInitialized();
  const pipelines = getPipelinesByProvider('github');
  ...
  return NextResponse.json({
    ...
    stats: {
      ...
      buildTrend: allStats.buildTrend.map((d) => ({ date: d.date, value: d.github })),
    },
  });
}
